...
const C4WLogo = () => (
  <div className="c4w-logo">
    <span className="c4w-mark">c4w</span>
    <span className="c4w-sub">Code for work</span>
  </div>
);
...
Object.assign(window, { EntityTag, StateDot, C4WLogo, LinkToggle, ConfirmModal });
