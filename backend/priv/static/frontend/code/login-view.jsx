...
// accounts seeded in the backend (any password is accepted for them). Same
// accounts/backend as the mail app — this is a second frontend, not a
// separate user base.
    ...
    <div className="login-screen">
      <div className="login-card">
        ...
        <div className="login-heads">
          ...
          <p className="login-sub">Beskriv ett mål, få en plan, se det genomfört.</p>
        </div>
